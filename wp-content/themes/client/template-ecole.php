...
<?php if (\wtl\Authentication::has_school_access()) : ?>
    ...
    <div class="backGroundPinkStageSchool">
        <section class="mySchool" data-showup="true">
            <article class="mySchool__intro">

                <h2 class="mySchool__title"><?= get_field('title') ?></h2>
                <div class="mySchool__text"><?= wp_kses_post(get_field('intervention_text')) ?></div>

            </article>


            <article class="mySchool__ref">
                <h3 class="mySchool__referent-title"><?= \wtl\Helpers::get_field('mon_ref') ?></h3>
                <p class="mySchool__referent-name"><?= \wtl\Helpers::get_field('referent_prenom') ?></p>
                <a class="mySchool__referent-contact"
